  ...
  <div class="consultation-container">
    <div class="sidebar">
      ...
      <div class="ai-assistant-info">
        ...
        <h3 class="assistant-name">云心说AI助手</h3>
            ...
            <div class="session-info">
              <div class="session-title">
                ...
                <div class="session-meta">
                  <span class="session-time">{{ session.statedAt }}</span>
                </div>
      ...
      <div class="chat-messages">
        ...
        <div class="message-item ai-message" v-if="messages.length === 0">
          ...
          <div class="message-content">
            <div class="message-bubble">
              <p>您好！我是小云，您的AI心理健康助手，很高兴陪伴您，为您提供温暖的心理支持，请您告诉我，今天您感觉如何？有什么想要和我分享的吗？</p>
            </div>
        ...
        <div v-for="msg in messages" :key="msg.id" class="message-item"
          ...
          <div class="message-content">
            ...
            <div class="message-time">{{ msg.senderType === 2 && isAiTyping ? '正在输入中...' :
              msg.createdAt }}</div>
          </div>
        </div>
      </div>
...
import { startSession, getSessionList, deleteSession, getSessionEmotion, getSessionDetail } from '@/api/frontend.js'
...
const createNewFrontendSession = () => {
  ...
  currentSession.value = newSesson
  // 清空消息列表
  messages.value = []
}
// 定义一个当前会话对象
...
const handleError = (error) => {
  ...
  const aiMessage = messages.value[messages.value.length - 1]
  if (aiMessage) {
    aiMessage.content = 'AI回复失败 请重新尝试'
  }
  isAiTyping.value = false
  ElMessage({
    type: 'error',
    message: 'AI回复失败 请重新尝试'
  })
  controller.abort()
}
// 定义处理键盘事件的函数
