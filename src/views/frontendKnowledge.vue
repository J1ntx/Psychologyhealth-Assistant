  ...
  <div class="knowledge-container">
    ...
    <div class="content">
      ...
      <div class="recommend-section">
        ...
        <div class="recommend-list">
          <div class="recommend-item" v-for="item in recommendList" :key="item.id" @click="jumpToArticle(item.id)">
            <h4>{{ item.title }}</h4>
            <p class="read-count">
              <el-icon>
                <Histogram />
      ...
      <div class="article-list">
        <div class="article-item" v-for="item in articleList" :key="item.id" @click="jumpToArticle(item.id)">
    ...
    <div class="pagination-wrapper">
      <el-pagination style="margin-top:25px" v-model:current-page="pagination.currentPage"
        v-model:page-size="pagination.size" :total="pagination.total" @change="handleChange"
...
import doubao from '@/assets/doubao_avatar.png'
...
// 图片路径处理
const getImage = (url) => {
  return url ? fileBaseurl + url : doubao
}
