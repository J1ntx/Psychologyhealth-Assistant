        ...
        <el-card v-if="aiData.systemOverview">
          <div class="card-content">
            ...
            <div class="info">
              ...
              <p class="number">{{ aiData.systemOverview?.totalUsers
              }}</p>
        ...
        <el-card v-if="aiData.systemOverview">
          <div class="card-content">
            ...
            <div class="info">
              ...
              <p class="number">{{ aiData.systemOverview.totalDiaries
              }}</p>
        ...
        <el-card v-if="aiData.systemOverview">
          <div class="card-content">
            ...
            <div class="info">
              ...
              <p class="number">{{ aiData.systemOverview?.totalSessions
              }}</p>
        ...
        <el-card v-if="aiData.systemOverview">
          <div class="card-content">
            ...
            <div class="info">
              ...
              <p class="number">{{ aiData.systemOverview.avgMoodScore
              }}/10</p>
...
const initEmotionChart = () => {
  ...
  const option = {
    ...
    yAxis: [
      {
        type: 'value', name: '情绪评分', position: 'left', axisLine: {
          lineStyle: {
            color: '#2d3436'
          }
        }
      ...
      {
        type: 'value', name: '记录数量', position: 'right', axisLine: {
          lineStyle: {
            color: '#2d3436'
          }
        }
